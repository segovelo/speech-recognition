...
import json
from youtb_extractor import get_video_info, get_audio_url
from assemblyai_handler import save_transcript
...
if __name__ == "__main__":
    ...
    with open("data/iPhone_13_Review:_Pros_and_Cons.json", "r") as f:
        data = json.load(f)
